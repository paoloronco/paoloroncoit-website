...
export const ui = {
  it: {
    ...
    'nav.about': 'About',
    'nav.contact': 'Contact',
    'header.search': 'Cerca articoli, progetti, skill…',
    'header.openPalette': "Cerca nel sito o chiedi all'AI",
  ...
  en: {
    ...
    'nav.about': 'About',
    'nav.contact': 'Contact',
    'header.search': 'Search articles, projects, skills…',
    'header.openPalette': 'Search the site or ask the AI',
